...
public final class RNames {
    ...
    public static final class id {
        ...
        public static final String ACTIVITY_CONTAINER = string.ID_ACTIVITY_CONTAINER;
    ...
    public static final class layout {
        ...
        public static final String ACTIVITY_CONTAINER = string.LAYOUT_ACTIVITY_CONTAINER;
        public static final String ACTIVITY_DRAWER = string.LAYOUT_ACTIVITY_DRAWER;
        public static final String ACTIVITY_DRAWER_NAVIGATION = string.LAYOUT_ACTIVITY_DRAWER_NAVIGATION;
    ...
    public static final class string {
        ...
        static final String LAYOUT_ACTIVITY_CONTAINER = "activity_container";
        static final String LAYOUT_ACTIVITY_DRAWER = "activity_drawer";
        static final String LAYOUT_ACTIVITY_DRAWER_NAVIGATION = "activity_drawer_navigation";

        static final String ID_ACTIVITY_CONTAINER = "activity_container";
        ...
        public static final String ERR_RESOURCE_ID_NOT_FOUND = "Resource ID not found";
        public static final String ERR_LAYOUT_RES_ID_NOT_FOUND =
                "Resource ID for an XML layout resource to load not found";
